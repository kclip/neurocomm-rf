...
class SpikeCPCutoff(BaseCutoff):
    def __init__(self, T, snn_settings, cutoff_settings, *args, **kwargs):
        """
        ...
        """
        self.T = snn_settings.T
        self.add_time_dim = snn_settings.add_time_dim
        self.bin_size = cutoff_settings.bin_size
        self.multistep = snn_settings.multistep
